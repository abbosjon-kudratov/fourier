Преобразования Фурье - это инструмент, используемый во множестве разных вещей. Это объяснение того, что делает преобразование Фурье, и некоторые другие способы, которые могут быть полезны. И как вы можете делать красивые вещи с этим, как эта вещь:

<canvas id="self-draw" class="sketch" width=500 height=500></canvas>

Я объясню, как работает эта анимация, и попутно объяснить преобразования Фурье!
